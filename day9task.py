# program to add +2 to every elemet of the list
...
#----------------x----------------------------------------------------------------------x-------------------------------
#program of multiplication table of 9
n_156 = int(9)
mul_21 = 0
...
#-----------------x-------------------------------------------------------------------------x---------------------------
#programm to convert days to ages
...
#----------------x---------------------------------------------------------------------------x--------------------------
#trignometry programm using math function
